...
class resnet_v1_101_fpn_dcn_rcnn(Symbol):
    ...
    def get_fpn_feature(self, c2, c3, c4, c5, feature_dim=256):
        ...
        # lateral connection
        fpn_p5_branch1 = mx.symbol.Convolution(data=c5, kernel=(1, 1), pad=(0, 0), stride=(1, 1), num_filter=feature_dim, name='fpn_p5_branch1')
        fpn_p5_branch2a = mx.symbol.Convolution(data=c5, kernel=(1, 1), pad=(0, 0), stride=(1, 1), num_filter=feature_dim/4, name='fpn_p5_branch2a')
        fpn_p5_branch2b = mx.symbol.Convolution(data=fpn_p5_branch2a, kernel=(3, 3), pad=(1, 1), stride=(1, 1), num_filter=feature_dim/4, name='fpn_p5_branch2b')
        fpn_p5_branch2c = mx.symbol.Convolution(data=fpn_p5_branch2b, kernel=(1, 1), pad=(0, 0), stride=(1, 1), num_filter=feature_dim, name='fpn_p5_branch2c')
        fpn_p5_lateral = mx.symbol.broadcast_add(name='fpn_p5_lateral', *[fpn_p5_branch1, fpn_p5_branch2c])
        
        fpn_p4_branch1 = mx.symbol.Convolution(data=c4, kernel=(1, 1), pad=(0, 0), stride=(1, 1), num_filter=feature_dim, name='fpn_p4_branch1')
        fpn_p4_branch2a = mx.symbol.Convolution(data=c4, kernel=(1, 1), pad=(0, 0), stride=(1, 1), num_filter=feature_dim/4, name='fpn_p4_branch2a')
        fpn_p4_branch2b = mx.symbol.Convolution(data=fpn_p4_branch2a, kernel=(3, 3), pad=(1, 1), stride=(1, 1), num_filter=feature_dim/4, name='fpn_p4_branch2b')
        fpn_p4_branch2c = mx.symbol.Convolution(data=fpn_p4_branch2b, kernel=(1, 1), pad=(0, 0), stride=(1, 1), num_filter=feature_dim, name='fpn_p4_branch2c')
        fpn_p4_lateral = mx.symbol.broadcast_add(name='fpn_p4_lateral', *[fpn_p4_branch1, fpn_p4_branch2c])
        
        fpn_p3_branch1 = mx.symbol.Convolution(data=c3, kernel=(1, 1), pad=(0, 0), stride=(1, 1), num_filter=feature_dim, name='fpn_p3_branch1')
        fpn_p3_branch2a = mx.symbol.Convolution(data=c3, kernel=(1, 1), pad=(0, 0), stride=(1, 1), num_filter=feature_dim/4, name='fpn_p3_branch2a')
        fpn_p3_branch2b = mx.symbol.Convolution(data=fpn_p3_branch2a, kernel=(3, 3), pad=(1, 1), stride=(1, 1), num_filter=feature_dim/4, name='fpn_p3_branch2b')
        fpn_p3_branch2c = mx.symbol.Convolution(data=fpn_p3_branch2b, kernel=(1, 1), pad=(0, 0), stride=(1, 1), num_filter=feature_dim, name='fpn_p3_branch2c')
        fpn_p3_lateral = mx.symbol.broadcast_add(name='fpn_p3_lateral', *[fpn_p3_branch1, fpn_p3_branch2c])
        
        fpn_p2_branch1 = mx.symbol.Convolution(data=c2, kernel=(1, 1), pad=(0, 0), stride=(1, 1), num_filter=feature_dim, name='fpn_p2_branch1')
        fpn_p2_branch2a = mx.symbol.Convolution(data=c2, kernel=(1, 1), pad=(0, 0), stride=(1, 1), num_filter=feature_dim/4, name='fpn_p2_branch2a')
        fpn_p2_branch2b = mx.symbol.Convolution(data=fpn_p2_branch2a, kernel=(3, 3), pad=(1, 1), stride=(1, 1), num_filter=feature_dim/4, name='fpn_p2_branch2b')
        fpn_p2_branch2c = mx.symbol.Convolution(data=fpn_p2_branch2b, kernel=(1, 1), pad=(0, 0), stride=(1, 1), num_filter=feature_dim, name='fpn_p2_branch2c')
        fpn_p2_lateral = mx.symbol.broadcast_add(name='fpn_p2_lateral', *[fpn_p2_branch1, fpn_p2_branch2c])

        # top-down connection
        fpn_p5_upsample = mx.symbol.UpSampling(fpn_p5_lateral, scale=2, num_filter=feature_dim, sample_type='bilinear', name='fpn_p5_upsample')
        fpn_p4_plus = mx.sym.ElementWiseSum(*[fpn_p5_upsample, fpn_p4_lateral], name='fpn_p4_sum')
        fpn_p4_upsample = mx.symbol.UpSampling(fpn_p4_plus, scale=2, num_filter=feature_dim, sample_type='bilinear', name='fpn_p4_upsample')
        fpn_p3_plus = mx.sym.ElementWiseSum(*[fpn_p4_upsample, fpn_p3_lateral], name='fpn_p3_sum')
        fpn_p3_upsample = mx.symbol.UpSampling(fpn_p3_plus, scale=2, num_filter=feature_dim, sample_type='bilinear', name='fpn_p3_upsample')
        fpn_p2_plus = mx.sym.ElementWiseSum(*[fpn_p3_upsample, fpn_p2_lateral], name='fpn_p2_sum')
        # FPN feature
        fpn_p6 = mx.sym.Convolution(data=c5, kernel=(3, 3), pad=(1, 1), stride=(2, 2), num_filter=feature_dim, name='fpn_p6')
        fpn_p5 = mx.symbol.Convolution(data=fpn_p5_lateral, kernel=(3, 3), pad=(1, 1), stride=(1, 1), num_filter=feature_dim, name='fpn_p5')
    ...
    def init_weight_fpn(self, cfg, arg_params, aux_params):
        ...
        arg_params['fpn_p5_branch1_weight'] = mx.random.normal(0, 0.01, shape=self.arg_shape_dict['fpn_p5_branch1_weight'])
        arg_params['fpn_p5_branch1_bias'] = mx.nd.zeros(shape=self.arg_shape_dict['fpn_p5_branch1_bias'])
        ...
        arg_params['fpn_p5_branch2c_weight'] = mx.random.normal(0, 0.01, shape=self.arg_shape_dict['fpn_p5_branch2c_weight'])
        arg_params['fpn_p5_branch2c_bias'] = mx.nd.zeros(shape=self.arg_shape_dict['fpn_p5_branch2c_bias'])
        arg_params['fpn_p5_upsample_weight'] = mx.random.normal(0, 0.01, shape=self.arg_shape_dict['fpn_p5_upsample_weight'])
        # arg_params['fpn_p5_upsample_bias'] = mx.nd.zeros(shape=self.arg_shape_dict['fpn_p5_upsample_bias'])

        arg_params['fpn_p4_branch1_weight'] = mx.random.normal(0, 0.01, shape=self.arg_shape_dict['fpn_p4_branch1_weight'])
        arg_params['fpn_p4_branch1_bias'] = mx.nd.zeros(shape=self.arg_shape_dict['fpn_p4_branch1_bias'])
        ...
        arg_params['fpn_p4_branch2c_weight'] = mx.random.normal(0, 0.01, shape=self.arg_shape_dict['fpn_p4_branch2c_weight'])
        arg_params['fpn_p4_branch2c_bias'] = mx.nd.zeros(shape=self.arg_shape_dict['fpn_p4_branch2c_bias'])
        arg_params['fpn_p4_upsample_weight'] = mx.random.normal(0, 0.01, shape=self.arg_shape_dict['fpn_p4_upsample_weight'])
        # arg_params['fpn_p4_upsample_bias'] = mx.nd.zeros(shape=self.arg_shape_dict['fpn_p4_upsample_bias'])

        arg_params['fpn_p3_branch1_weight'] = mx.random.normal(0, 0.01, shape=self.arg_shape_dict['fpn_p3_branch1_weight'])
        arg_params['fpn_p3_branch1_bias'] = mx.nd.zeros(shape=self.arg_shape_dict['fpn_p3_branch1_bias'])
        ...
        arg_params['fpn_p3_branch2c_weight'] = mx.random.normal(0, 0.01, shape=self.arg_shape_dict['fpn_p3_branch2c_weight'])
        arg_params['fpn_p3_branch2c_bias'] = mx.nd.zeros(shape=self.arg_shape_dict['fpn_p3_branch2c_bias'])
        arg_params['fpn_p3_upsample_weight'] = mx.random.normal(0, 0.01, shape=self.arg_shape_dict['fpn_p3_upsample_weight'])
        # arg_params['fpn_p3_upsample_bias'] = mx.nd.zeros(shape=self.arg_shape_dict['fpn_p3_upsample_bias'])

        arg_params['fpn_p2_branch1_weight'] = mx.random.normal(0, 0.01, shape=self.arg_shape_dict['fpn_p2_branch1_weight'])
        arg_params['fpn_p2_branch1_bias'] = mx.nd.zeros(shape=self.arg_shape_dict['fpn_p2_branch1_bias'])
        ...
        arg_params['fpn_p2_branch2c_weight'] = mx.random.normal(0, 0.01, shape=self.arg_shape_dict['fpn_p2_branch2c_weight'])
        arg_params['fpn_p2_branch2c_bias'] = mx.nd.zeros(shape=self.arg_shape_dict['fpn_p2_branch2c_bias'])

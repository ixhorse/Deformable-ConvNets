...
class resnet_v1_101_rfcn_cascade(Symbol):
    ...
    def get_symbol(self, cfg, is_train=True):
        ...
        bbox_delta = rpn_bbox_pred
        for stage in range(3):
            output = self.get_rfcn_head(stage+1, rfcn_cls, rfcn_bbox, rois, gt_boxes, bbox_delta, im_info, 
    ...
    def get_rfcn_head(self, stage, rfcn_cls, rfcn_bbox, rois, gt_boxes, bbox_delta, im_info,
                        num_reg_classes, num_classes, is_train, cfg):
        # cascade rfcn head
